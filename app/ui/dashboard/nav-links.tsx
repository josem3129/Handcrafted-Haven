...
const links = [
  { name: "Home", href: "/dashboard", icon: HomeIcon, as: "style" },
  { name: "Profile", href: "/dashboard/profile", icon: HomeIcon, as: "style" },
  {
    name: "Shop",
  ...
  { name: "Add listing", href: "/dashboard/invoices/create", icon: UserGroupIcon },
];
